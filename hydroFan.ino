...
DA_DiscreteOutput B1R1_1A_XY_023 = DA_DiscreteOutput(A3, HIGH); // Fan
...
{
  checkAndActivateDO(B1R1_1A_XY_023_MB, & B1R1_1A_XY_023);
  checkAndResetDO(B1R1_1A_XY_023_MB, & B1R1_1A_XY_023);
